...
<body>
	...
	<input type="text" placeholder="User Name or Email" class="txt" name="username"><br>
	<h3>Password</h3>
	<input type="password"placeholder="Password" class="txt" name="password"><br>
	<button>Button</button class="btn" name="btn-login" >
